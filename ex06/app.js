...
if(fruits.includes('abacaxi')) console.log('A string "abacaxi" existe no array fruits.')
  else if (fruits.includes('pera')) console.log('A string "pera" existe no array fruits.')
...
if(currentHour >= 6 && currentHour < 12) console.log('Bom dia!')
  else if(currentHour < 18 && currentHour >= 12) console.log('Boa tarde!')
...
if(age <= 7 || age >= 65) messageTicket = "Para você, a entrada é grátis!"
  else messageTicket = "A entrada é R$ 30,00."
...
const betweenElevenAndNinty = []

for(let i = 0; i < numbers.length; i++) {
  const number = numbers[i]

  if(number >= 11 && number <= 90) betweenElevenAndNinty.push(number)
}

// console.log(betweenElevenAndNinty)
