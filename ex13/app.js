...
const getZequinha  = dog => dog.name === 'Zequinha'

// console.log(dogs.find(getZequinha))
...
const secondaryTitlesEl = document.querySelectorAll('.secondary-title')

// console.log(secondaryTitlesEl)