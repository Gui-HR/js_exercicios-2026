...
const stringLenght = string => string.length

// console.log(stringLenght('Ola a todos'))
...
// myToLowerCase('CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO')
...
const myIndexOf = (string, char) => string.indexOf(char)

// console.log(myIndexOf('Saboneteira', 'r'))
...
const myIncludes = (list, item) => list.includes(item)

// console.log(myIncludes([1, 2, 3, 4, 5, 6], 5))
...
// console.log(myConcat([1, 2, 3], ['eu', 'quero', 'jogar']))
/*
  07
